...
<!-- Lists the universities in for the United Kindom as wwell as extracting the data from the api -->
<div>
    ...
    <script type="text/javascript">
        ...
        var req = $.ajax({
        url: "https://cors-anywhere.herokuapp.com/http://universities.hipolabs.com/search?country=United Kingdom",
          type:"get",
            dataType: "json"
        });
